...
- [Limitations](https://docs.aws.amazon.com/lambda/latest/dg/limits.html)
...
- Other HTMP responses, e.g. PNG, JPEG
...
- Deploying R in production is a "good problem to have"
- Diverse approaches towards API
- Competitive FaaS providers
